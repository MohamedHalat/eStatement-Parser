...
const endOfInputText = _i18n.i18n.translate('data.common.esQuery.kql.errors.endOfInputText', {
  defaultMessage: 'end of input'
});

const grammarRuleTranslations = {
  fieldName: _i18n.i18n.translate('data.common.esQuery.kql.errors.fieldNameText', {
    defaultMessage: 'field name'
  }),
  value: _i18n.i18n.translate('data.common.esQuery.kql.errors.valueText', {
    defaultMessage: 'value'
  }),
  literal: _i18n.i18n.translate('data.common.esQuery.kql.errors.literalText', {
    defaultMessage: 'literal'
  }),
  whitespace: _i18n.i18n.translate('data.common.esQuery.kql.errors.whitespaceText', {
...
class KQLSyntaxError extends Error {
  constructor(error, expression) {
    ...
    if (error.expected) {
      ...
      message = _i18n.i18n.translate('data.common.esQuery.kql.errors.syntaxError', {
