...
const TRANSFORM_OPTIONS = [{
  kind: false,
  text: _i18n.i18n.translate('data.common.fieldFormats.string.transformOptions.none', {
    defaultMessage: '- None -'
  })
}, {
  kind: 'lower',
  text: _i18n.i18n.translate('data.common.fieldFormats.string.transformOptions.lower', {
    defaultMessage: 'Lower Case'
  })
}, {
  kind: 'upper',
  text: _i18n.i18n.translate('data.common.fieldFormats.string.transformOptions.upper', {
    defaultMessage: 'Upper Case'
  })
}, {
  kind: 'title',
  text: _i18n.i18n.translate('data.common.fieldFormats.string.transformOptions.title', {
    defaultMessage: 'Title Case'
  })
}, {
  kind: 'short',
  text: _i18n.i18n.translate('data.common.fieldFormats.string.transformOptions.short', {
    defaultMessage: 'Short Dots'
  })
}, {
  kind: 'base64',
  text: _i18n.i18n.translate('data.common.fieldFormats.string.transformOptions.base64', {
    defaultMessage: 'Base64 Decode'
  })
}, {
  kind: 'urlparam',
  text: _i18n.i18n.translate('data.common.fieldFormats.string.transformOptions.url', {
  ...
  constructor(...args) {
    ...
    _defineProperty(this, "textConvert", val => {
      switch (this.param('transform')) {
        ...
        case 'short':
          return (0, _utils.shortenDottedString)(val);
        ...
        default:
          return (0, _index.asPrettyString)(val);
      }
    });
  }
