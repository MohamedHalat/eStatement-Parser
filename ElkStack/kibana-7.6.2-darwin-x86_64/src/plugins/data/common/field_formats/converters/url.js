...
const URL_TYPES = [{
  kind: 'a',
  text: _i18n.i18n.translate('data.common.fieldFormats.url.types.link', {
    defaultMessage: 'Link'
  })
}, {
  kind: 'img',
  text: _i18n.i18n.translate('data.common.fieldFormats.url.types.img', {
    defaultMessage: 'Image'
  })
}, {
  kind: 'audio',
  text: _i18n.i18n.translate('data.common.fieldFormats.url.types.audio', {
