...
class FieldFormat {
  ...
  setupContentType() {
    return {
      [_content_types.TEXT_CONTEXT_TYPE]: (0, _content_types.textContentTypeSetup)(this, this.textConvert),
      [_content_types.HTML_CONTEXT_TYPE]: (0, _content_types.htmlContentTypeSetup)(this, this.htmlConvert)
    };
  }
