...
function (_Component) {
  ...
  function UrlPanelContent(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getSnapshotUrl", function () {
      return _this.props.shareableUrl || window.location.href;
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "makeIframeTag", function (url) {
      ...
      return "<iframe src=\"".concat(embeddableUrl, "\" height=\"600\" width=\"800\"></iframe>");
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleShortUrlChange", function _callee(evt) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              _context.prev = 5;
              _context.next = 8;
              return regeneratorRuntime.awrap((0, _url_shortener.shortenUrl)(_this.getSnapshotUrl(), {
