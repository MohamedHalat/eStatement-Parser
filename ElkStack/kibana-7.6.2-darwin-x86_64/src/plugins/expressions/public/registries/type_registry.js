...
/*#__PURE__*/
function (_Registry) {
  _inherits(TypesRegistry, _Registry);
  ...
  _createClass(TypesRegistry, [{
    key: "register",
    value: function register(typeDefinition) {
      var type = new _type.Type(_typeof(typeDefinition) === 'object' ? typeDefinition : typeDefinition());
