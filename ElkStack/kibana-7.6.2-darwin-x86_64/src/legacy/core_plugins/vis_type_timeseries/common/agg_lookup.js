...
function createOptions(type = '_all', siblings = []) {
  ...
  return (0, _lodash.default)(aggs).map((label, value) => {
    const disabled = _lodash.default.includes(pipeline, value) ? !enablePipelines : false;
    return {
      label: disabled ? _i18n.i18n.translate('visTypeTimeseries.aggLookup.addPipelineAggDescription', {
