...
function stanMetricsSpecProvider(context) {
  ...
  return {
    id: 'stanMetrics',
    name: _i18n.i18n.translate('kbn.server.tutorials.stanMetrics.nameTitle', {
      defaultMessage: 'STAN metrics'
    }),
    category: _tutorial_category.TUTORIAL_CATEGORY.METRICS,
    shortDescription: _i18n.i18n.translate('kbn.server.tutorials.stanMetrics.shortDescription', {
      defaultMessage: 'Fetch monitoring metrics from the STAN server.'
    }),
    longDescription: _i18n.i18n.translate('kbn.server.tutorials.stanMetrics.longDescription', {
