 ...
 * under the License.
 */
function awsLogsSpecProvider(server, context) {
  const moduleName = 'aws';
  const platforms = ['OSX', 'DEB', 'RPM', 'WINDOWS'];
  return {
    id: 'awsLogs',
    name: _i18n.i18n.translate('kbn.server.tutorials.awsLogs.nameTitle', {
      defaultMessage: 'AWS S3 based logs'
    }),
    category: _tutorial_category.TUTORIAL_CATEGORY.LOGGING,
    shortDescription: _i18n.i18n.translate('kbn.server.tutorials.awsLogs.shortDescription', {
      defaultMessage: 'Collect AWS logs from S3 bucket with Filebeat.'
    }),
    longDescription: _i18n.i18n.translate('kbn.server.tutorials.awsLogs.longDescription', {
...
[Learn more]({learnMoreLink}).',
    ...
    artifacts: {
      dashboards: [{
        ...
        linkLabel: _i18n.i18n.translate('kbn.server.tutorials.awsLogs.artifacts.dashboards.linkLabel', {
