...
function consulMetricsSpecProvider(context) {
  ...
  return {
    id: 'consulMetrics',
    name: _i18n.i18n.translate('kbn.server.tutorials.consulMetrics.nameTitle', {
      defaultMessage: 'Consul metrics'
    }),
    category: _tutorial_category.TUTORIAL_CATEGORY.METRICS,
    shortDescription: _i18n.i18n.translate('kbn.server.tutorials.consulMetrics.shortDescription', {
      defaultMessage: 'Fetch monitoring metrics from the Consul server.'
    }),
    longDescription: _i18n.i18n.translate('kbn.server.tutorials.consulMetrics.longDescription', {
...
[Learn more]({learnMoreLink}).',
    ...
    artifacts: {
      dashboards: [{
        ...
        linkLabel: _i18n.i18n.translate('kbn.server.tutorials.consulMetrics.artifacts.dashboards.linkLabel', {
