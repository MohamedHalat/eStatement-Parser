...
const createJsAgentInstructions = (apmServerUrl = '') => [{
  ...
  textPre: _i18n.i18n.translate('kbn.server.tutorials.apm.jsClient.enableRealUserMonitoring.textPre', {
    ...
    values: {
      documentationLink: '{config.docs.base_url}guide/en/apm/server/{config.docs.version}/rum.html'
    }
  })
}, {
...
const createDotNetAgentInstructions = (apmServerUrl = '', secretToken = '') => [{
  title: _i18n.i18n.translate('kbn.server.tutorials.apm.dotNetClient.download.title', {
    defaultMessage: 'Download the APM agent'
  }),
  textPre: _i18n.i18n.translate('kbn.server.tutorials.apm.dotNetClient.download.textPre', {
  ...
  title: _i18n.i18n.translate('kbn.server.tutorials.apm.dotNetClient.configureApplication.title', {
    defaultMessage: 'Add the agent to the application'
  }),
  textPre: _i18n.i18n.translate('kbn.server.tutorials.apm.dotNetClient.configureApplication.textPre', {
...
{curlyOpen}
  ...
  //…rest of the class
{curlyClose}`.split('\n'),
  textPost: _i18n.i18n.translate('kbn.server.tutorials.apm.dotNetClient.configureApplication.textPost', {
  ...
  title: _i18n.i18n.translate('kbn.server.tutorials.apm.dotNetClient.configureAgent.title', {
  ...
  {curlyClose}
{curlyClose}`.split('\n'),
  textPost: _i18n.i18n.translate('kbn.server.tutorials.apm.dotNetClient.configureAgent.textPost', {
