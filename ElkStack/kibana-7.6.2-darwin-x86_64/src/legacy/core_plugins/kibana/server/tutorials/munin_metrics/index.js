...
function muninMetricsSpecProvider(context) {
  ...
  return {
    id: 'muninMetrics',
    name: _i18n.i18n.translate('kbn.server.tutorials.muninMetrics.nameTitle', {
    ...
    longDescription: _i18n.i18n.translate('kbn.server.tutorials.muninMetrics.longDescription', {
...
[Learn more]({learnMoreLink}).',
    ...
    artifacts: {
      application: {
        label: _i18n.i18n.translate('kbn.server.tutorials.muninMetrics.artifacts.application.label', {
