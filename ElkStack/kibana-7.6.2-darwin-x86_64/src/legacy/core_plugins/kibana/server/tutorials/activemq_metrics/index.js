...
function activemqMetricsSpecProvider(context) {
  ...
  return {
    id: 'activemqMetrics',
    name: _i18n.i18n.translate('kbn.server.tutorials.activemqMetrics.nameTitle', {
      defaultMessage: 'ActiveMQ metrics'
    }),
    category: _tutorial_category.TUTORIAL_CATEGORY.METRICS,
    shortDescription: _i18n.i18n.translate('kbn.server.tutorials.activemqMetrics.shortDescription', {
      defaultMessage: 'Fetch monitoring metrics from ActiveMQ instances.'
    }),
    longDescription: _i18n.i18n.translate('kbn.server.tutorials.activemqMetrics.longDescription', {
...
[Learn more]({learnMoreLink}).',
    ...
    artifacts: {
      application: {
        label: _i18n.i18n.translate('kbn.server.tutorials.corednsMetrics.artifacts.application.label', {
