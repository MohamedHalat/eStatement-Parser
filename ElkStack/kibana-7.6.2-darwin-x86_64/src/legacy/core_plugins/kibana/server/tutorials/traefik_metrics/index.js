 ...
 * under the License.
 */
function traefikMetricsSpecProvider(server, context) {
  const moduleName = 'traefik';
  return {
    id: 'traefikMetrics',
    name: _i18n.i18n.translate('kbn.server.tutorials.traefikMetrics.nameTitle', {
      defaultMessage: 'Traefik metrics'
    }),
    category: _tutorial_category.TUTORIAL_CATEGORY.METRICS,
    shortDescription: _i18n.i18n.translate('kbn.server.tutorials.traefikMetrics.shortDescription', {
      defaultMessage: 'Fetch monitoring metrics from Traefik.'
    }),
    longDescription: _i18n.i18n.translate('kbn.server.tutorials.traefikMetrics.longDescription', {
