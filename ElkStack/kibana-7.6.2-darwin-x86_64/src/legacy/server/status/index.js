...
function statusMixin(kbnServer, server, config) {
  ...
  (0, _collectors.registerOpsStatsCollector)(usageCollection, server, kbnServer);
  ...
  (0, _routes.registerStatsApi)(usageCollection, server, config); // expore shared functionality
