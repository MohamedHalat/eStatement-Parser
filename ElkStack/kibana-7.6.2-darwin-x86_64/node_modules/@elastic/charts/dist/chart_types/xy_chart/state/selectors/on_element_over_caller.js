...
function createOnElementOverCaller() {
    ...
    return function (state) {
        if (selector === null && state.chartType === index_1.ChartTypes.XYAxis) {
            selector = re_reselect_1.default([get_tooltip_values_highlighted_geoms_1.getTooltipValuesAndGeometriesSelector, get_settings_specs_1.getSettingsSpecSelector], function (_a, settings) {
                ...
                if (isOverElement(prevProps, nextProps) && settings.onElementOver) {
                    settings.onElementOver(highlightedGeometries.map(function (_a) {
                        var value = _a.value;
                        return value;
                    }));
                }
